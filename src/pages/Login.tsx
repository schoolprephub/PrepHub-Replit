...
const Login = () => {
  ...
  const existingSession = localStorage.getItem('folder_user_session');
  if (existingSession) {
    ...
    try {
      ...
      if (error || !data) {
        toast({
          ...
          description: "Account not found. Please contact your school or admin for access.",
          variant: "destructive",
        });
        setIsLoading(false);
        return;
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 right-1/4 w-32 h-32 bg-secondary/10 rounded-full blur-2xl animate-pulse delay-500"></div>
      </div>
